            ...
            <div className="work"  id="ibm">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        <p>
                            <u>Summer 2017:</u> With the Advanced Client Technology & Solutions team, I developed a video summarization algorithm, API, and client using Watson Developer Cloud services and offerings.</p>
            ...
            <div className="work" id="brh">
                <div className="work-container">
                    <div className="work-desc">
                        ...
                        As the Web Team Lead, I work with other team members to plan and implement essential functionality and software for our website. I am also the first point of contact to address issues that are identified on GitHub and in Slack. On the day of the event, I support hackers and event logistics by resolving any critical website errors. I am currently leading a rebuild of our website with React, PostgreSQL, Node.js, and Express.
                    </div>
                    <div className="work-pic">
                    </div>
                </div>
            ...
            <div className="work" id="cornell">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        Responsibilities include holding walk-in office hours, grading student assignments, addressing questions using Piazza (online class management software) and teaching a 20-student discussion section (1300/2300).
                        <table id="ta-table">
                            <thead>
                                <tr>
                                    <th>Course #</th>
            ...
            <div className="work" id="slope">
                <div className="work-container">
                    <div className="work-desc">
                        ...
                        <a href="http://slopeday.cornell.edu" target="_blank">Slope Day</a> is Cornell University's largest music event, attended by thousands of people. As the Recruitment Director, I redesigned the Slope Day website (in coordination with the  Branding Director) with new branding, information, and flavor. Ongoing responsibilities include advertisement to the Cornell student body, organizing committees for members to participate in, and managing our email list.
                        <h3>Volunteer Director (May 2016 - May 2017)</h3>
                        Director in charge of volunteers for Slope Day festival, including Cornell students, faculty, and staff. Recruit volunteers and coordinate their duties, meet with other volunteer leads, and discuss
