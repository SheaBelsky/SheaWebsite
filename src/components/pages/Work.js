            ...
            <div className="work" id="ezra">
                <div className="work-container">
                    <div className="work-desc">
                        ...
                        <a href="https://www.ezratech.us" target="_blank">Ezra Tech</a> is a full-stack
                        solution for Science Olympiad event management. Created & maintain client experience
                        and server-side processing to aid tournament organizers, coaches, and participants
            ...
            <div className="work" id="dti">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        <a href="http://cornelldti.org" target="_blank">Cornell DTI</a> is a group of
                        students who are passionate about, making a change in our community through
                        design and technology. As Developer Lead, I coordinated front end developers
                        across all DTI projects, aided individual projects on an ad-hoc basis, interviewed
                        potential front end developers, and onboarded new project team members.
                    </div>
                </div>
            </div>
            ...
            <div className="work" id="slope">
                <div className="work-container">
                    <div className="work-desc">
                        ...
                        <h3>Recruitment Director (May 2017 - May 2018)</h3>
                        <a href="http://slopeday.cornell.edu" target="_blank">Slope Day</a> is Cornell
                        University's largest music event, attended by thousands of people. As the
                        Recruitment Director, I redesigned the Slope Day website (in coordination with
                        the Branding Director) with new branding, information, and flavor. I also distributed
                        advertisements to the Cornell student body, organized committees for general
                        body members to participate in, and managed our email list.
                        <h3>Volunteer Director (May 2016 - May 2017)</h3>
                        Director in charge of volunteers for Slope Day festival, including Cornell students,
                        faculty, and staff. Recruited volunteers and coordinated their duties, met with
            ...
            <div className="work" id="issa">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        and managed online presence. The President also interacted with members of faculty
                        and staff to increase club presence, and provided outreach to new and prospective
