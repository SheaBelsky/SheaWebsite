            ...
            <div className="work" id="dti">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        <p>
                            <a href="http://cornelldti.org" rel="noopener noreferrer" target="_blank">Cornell DTI</a> is a group of students who are passionate about community impact through  technology. As Developer Lead, I coordinated developers across the team, aided individual projects, interviewed candidates, and onboarded new members.
                        </p>
            ...
            <div className="work" id="cornell">
                <div className="work-container">
                    ...
                    <div className="work-desc">
                        ...
                        <p>
                            Responsibilities include holding walk-in office hours, grading student assignments, addressing questions using Piazza and teaching a 20-student discussion section. Undergraduate TA for INFO/CS 1300, 2300, 3300, and 4310.
                        </p>
                        <p>
                            Head TA for INFO 4340, User Experience and Software Development Studio. My responsibilities include aiding the professor with syllabus and course development, organizing undergraduate TAs, holding office hours, and attending lectures.
                        </p>
                    </div>
                </div>
            </div>
